...
The objective of this phase is to construct the environment-specific master guard assets for **Google Antigravity** under `fullstack_software_dev/plan/antigravity/guards/`.

### Role of this Implementation Map vs. Universal Design Baselines
*   **Universal Design & Architectural Baselines (Platform-Agnostic)**: [plan_workflow.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_workflow.md), [plan_questions.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_questions.md), [implementation_map_taxonomy.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/implementation_map_taxonomy.md), [folder_structure.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/folder_structure.md), [process_handling.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/process_handling.md), and [summary.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/summary.md) form the platform-agnostic design specification. These baselines define the theoretical workflows, 6-Phase Blueprint Architecture, and state machine rules so they can be implemented in any AI agent environment (e.g. OpenAI Codex, Claude Code, Cursor, or Antigravity).
...
| :--- | :--- | :--- | :--- |
| **Resource Usage & Governance Rule** | [plan_workflow.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_workflow.md#L19-L27) | Rule & Template Primitives | `rules/plan-grill.md` & `templates/PROCESS_STATUS.md` |
| **6-Phase Blueprint Architecture** | [plan_workflow.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_workflow.md#L115-L124) | Template & Skill Primitives | `templates/phase-*.md` (Phase 1–6) & `skills/plan-generator/SKILL.md` |
| **Pure Control Plane Sandbox (`agent-workspace/plans/<feature-name>/`)** | [folder_structure.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/folder_structure.md) & [plan_questions.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_questions.md#L16-L18) | Rule & Boundary Primitives | `rules/plan-grill.md` (Baseline 2) |
| **Initial Feature Summary Start Mandate (Node S2)** | [plan_questions.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_questions.md#L12-L15) | Workflow & Rule Primitives | `workflows/plan.md` (Node S2) & `rules/plan-grill.md` (Baseline 1) |
| **Decisions Embedded Directly in `phase-*.md` (No Decisions Subfolder)** | [plan_questions.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_questions.md#L19-L22) | Rule & Template Primitives | `rules/plan-grill.md` (Baseline 3) & `templates/phase-*.md` |
| **Research Reports in `knowledge/` & Linked** | [plan_workflow.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_workflow.md#L55-L58) | Skill & Template Primitives | `skills/plan-generator/SKILL.md` (`knowledge/research_report_<topic>.md`) |
| **On-Demand Subfolders (`phase_details/`)** | [plan_workflow.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_workflow.md#L59-L70) | Rule & Skill Primitives | `rules/plan-grill.md` & `skills/plan-generator/SKILL.md` |
| **Versioned Implementation Maps (`implementation_maps/`)** | [implementation_map_taxonomy.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/implementation_map_taxonomy.md) | Skill & Template Primitives | `skills/plan-generator/SKILL.md` (`implementation_map_v<version>.md`) |
| **Implementation Map Sandbox Guard (No Code Execution)** | [plan_questions.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_questions.md#L23-L26) | Rule Primitive | `rules/plan-grill.md` (Baseline 4) |
| **Sequential Q1–Q11 Grill Schema** | [plan_questions.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_questions.md#L51-L175) | Rule & Workflow Primitives | `rules/plan-grill.md` & `workflows/plan.md` |
| **Branch Process Status (`PROCESS_STATUS.md`)** | [process_handling.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/process_handling.md) | Template & Workflow Primitives | `templates/PROCESS_STATUS.md` & `workflows/plan.md` |
...
*   **List of Actions**:
    1. Inspect directory `fullstack_software_dev/plan/antigravity/guards/`.
    2. If `fullstack_software_dev/plan/antigravity/guards/` contains pre-existing guard files or subdirectories (`workflows/`, `rules/`, `templates/`, `skills/`, `hooks/`), remove all existing sources inside `fullstack_software_dev/plan/antigravity/guards/`.
...
*   **List of Actions**:
    1. Create Antigravity tier-3 guard root directory: `fullstack_software_dev/plan/antigravity/guards/`.
    2. Create primitive subdirectories:
        *   `fullstack_software_dev/plan/antigravity/guards/workflows/`
        *   `fullstack_software_dev/plan/antigravity/guards/rules/`
        *   `fullstack_software_dev/plan/antigravity/guards/templates/`
        *   `fullstack_software_dev/plan/antigravity/guards/skills/plan-generator/`
        *   `fullstack_software_dev/plan/antigravity/guards/hooks/`
*   **Reasons & Design Decision Links**:
    *   *Master Location*: Maintains master Antigravity guard primitives under `fullstack_software_dev/plan/antigravity/guards/` for central management before deploying into target project `agent-workspace/.agents/` directories.
    *   *Folder Taxonomy*: Mirrors the agentic control directory structure documented in [folder_structure.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/folder_structure.md).
...
*   **List of Actions**:
    1. Create `fullstack_software_dev/plan/antigravity/guards/workflows/plan.md`.
...
*   **Reasons & Design Decision Links**:
        *   *State Machine Lifecycle*: Realizes the 7-node execution design documented in [plan_workflow.md Section 4](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_workflow.md#L170-L245).
...
*   **List of Actions**:
    1. Create `fullstack_software_dev/plan/antigravity/guards/rules/plan-grill.md`.
    ...
    4. Encode Q1–Q11 questionnaire schema matching [plan_questions.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/plan_questions.md).
...
*   **List of Actions**:
    1. Create `fullstack_software_dev/plan/antigravity/guards/skills/plan-generator/SKILL.md`.
    ...
    5. Define procedure for drafting `implementation_maps/implementation_map_v<version>.md` adhering to [implementation_map_taxonomy.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/implementation_map_taxonomy.md).
...
*   **List of Actions**:
    1. Create `fullstack_software_dev/plan/antigravity/guards/templates/PROCESS_STATUS.md`: Pre-configured matrix template with sub-rows 3.1–3.6 for 6 planning phases and versioned implementation map rows.
    2. Create `fullstack_software_dev/plan/antigravity/guards/templates/GRILL_STATUS.md`: Stateful transcript log template for `/plan` interview sessions.
    3. Create `fullstack_software_dev/plan/antigravity/guards/templates/phase-1-summary.md` through `phase-6-operation.md`: Starter blueprint templates featuring embedded decision sections and research link placeholders.
    4. Create `fullstack_software_dev/plan/antigravity/guards/templates/implementation_map.md`: Starter implementation map template adhering to 5-block taxonomy schema with version header.
...
*   **List of Actions**:
    1. Create `fullstack_software_dev/plan/antigravity/guards/hooks/pre-commit-plan-validator.sh`.
...
*   Validate that all generated files in `fullstack_software_dev/plan/antigravity/` execute cleanly.
*   Run verification test suite defined in [plan_tests.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/plan/antigravity/plan_tests.md).

...
| **Pure Control Plane (`agent-workspace/`) & Sub-Repo Layout** | [folder_structure.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/init/folder_structure.md) | Rule & Skill Primitives | `rules/process-history-grill.md` (Baseline 2) & `skills/process-history-migrator/SKILL.md` |
...
| **Modular Workspace Code Graph Subfolders** | [folder_structure.md](file:///Users/horvathgergo/Desktop/agent-driven-templates/fullstack_software_dev/init/folder_structure.md#L34-L45) | Skill & Template Primitives | `skills/process-history-migrator/SKILL.md` & `templates/code_graph/` |
